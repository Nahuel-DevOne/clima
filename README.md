# **`App del clima`** 
# *`Consumiendo la API OpenWeather `* 
### **`Nahuel-DevOne`**
...
El proyecto es una app muy sencilla, que consume la API de OpenWeather para mostrar la temperatura actual, máxima y mínima, según la ciudad y el país.
